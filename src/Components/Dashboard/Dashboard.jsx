...
const Dashboard = () => {
  ...
  return (
    <div>
        ...
        <h1><a className="navbar-brand col-sm-3 col-md-2 mr-0" href="#"> Dashboard</a></h1>
<input type="text" className="form-control form-control-primary w-100" placeholder="Search..." />
