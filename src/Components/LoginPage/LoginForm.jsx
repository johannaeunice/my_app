    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-50 to-orange-50">
      ...
      <div className="min-h-screen flex justify-center items-center px-4 py-16">
        <div className="w-full max-w-4xl bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
          ...
          >
            <div className="mb-6">
              <h1 className="text-2xl font-bold text-[#333333] mb-2">Welcome Back</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <Link to="/forgot-password" className="text-xs text-[#007CC3] hover:underline">Forgot password?</Link>
                </div>
          ...
          >
            ...
            <div className="h-full flex flex-col justify-center">
              ...
              >
                <h2 className="text-3xl font-bold text-white mb-6">Welcome Back to Malingo!</h2>
                <p className="text-white text-lg mb-8">
                  Find your next adventure and connect with like-minded individuals
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-center">
                    ...
                    <p className="text-white">Discover new events near you</p>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <p className="text-white">Filter activities by interest</p>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <p className="text-white">Chat with activity partners</p>
                  </div>
                </div>
              </motion.div>
            </div>
